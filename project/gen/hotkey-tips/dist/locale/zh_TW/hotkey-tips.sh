...
"Alt + Shift + f" "開啟檔案管理器 (dde-file-manager)" "#cccccc" "Monospace 16" \
"Alt + Shift + g" "開啟檔案管理器 (pcmanfm-qt)" "#ffffff" "Monospace 16" \
"Alt + Shift + e" "開啟 (gxde-editor)" "#cccccc" "Monospace 16" \
"Alt + Shift + b" "開啟網頁瀏覽器 (firefox)" "#ffffff" "Monospace 16" \
"Alt + Shift + s" "開啟系統設定 (dde-control-center -t)" "#cccccc" "Monospace 16" \
"Alt + Enter" "開啟 Terminal (gxde-terminal)" "#ffffff" "Monospace 16" \
"Alt + Shift + a" "開啟 Terminal (gxde-terminal)" "#cccccc" "Monospace 16" \
"Alt + Ctrl + a" "開啟 Terminal (sakura)" "#ffffff" "Monospace 16" \
"Alt + Shift + t" "開啟 Terminal (gxde-terminal)" "#cccccc" "Monospace 16" \
